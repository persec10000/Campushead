...
export default class Pricing extends Component {
  ...
  _retrieveData = async () => {
    try {
      ...
      const team_id = await AStorageManager.getTeamId();
  ...
  async componentDidMount () {
    ...
    purchaseUpdateSubscription = purchaseUpdatedListener (async purchase => {
      ...
      this.setState ({receipt: purchase.transactionReceipt}, () =>
        this.goNext (purchase.purchaseToken)
      );
    });
            ...
            <View style={styles.ViewBenefit}>
              <View style={{flexDirection: 'row'}}>
                <View style={styles.ViewTitleBenefit}>
                  <Text style={[styles.TitleBenefit, {marginBottom: 3}]}>
                    Unlimited
                  </Text>
                </View>
                <View style={{flex: 1, marginLeft: 8}}>
                  <Text style={[styles.ContentBenefit, {marginBottom: 3}]}>
                    Songs
                  </Text>
                </View>
              </View>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  productList &&
                    ...
                    this.upgrade (productList.productId);
                }}
              >
