...
import {Container, Header, Left, Right, Card, Body} from 'native-base';
...
export default class Profile extends Component {
  ...
  updateProfile () {
    ...
    console.log ('editProfileUrl: ' + editProfileUrl);
    ...
    FireBaseApp.firestore ()
      ...
      .update ({
        email: this.state.email,
        username: this.state.username,
        profileURL: this.state.selectedFile
  ...
  reauthenticate = currentPassword => {
    ...
    var cred = FireBaseApp.auth.EmailAuthProvider.credential (
      user.email,
      currentPassword
    );
  ...
  changePassword () {
    ...
    this.reauthenticate (this.state.curPassword)
      .then (() => {
        var user = FireBaseApp.auth ().currentUser;
        user
          ...
          <Card>
            <View style={styles.floatingView}>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                >
                  {this.state.user.data.membership == 'free' ||
                    this.state.user.data.membership == null
                    ? null
                    : <Image
